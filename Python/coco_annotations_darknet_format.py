#######################################################################################################
# -*- coding:utf-8 -*-
# File: coco_annotations_darknet_format.py
# Update: 2020/05/26
# USAGE: python coco_annotations_darknet_format.py
# Description: Download COCO dataset and annotations from http://mscoco.org/dataset/.
########################################################################################################
import os
import json
