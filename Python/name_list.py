...
# File: name_list.py
# Update: 2020/05/26
# USAGE: python name_list.py
# Description: None
#######################################################################################################

import os
path = '/media/lab/data/detection_data/1127/JPEGImages/'         # 替换为你的路径
dir = os.listdir(path)                  # dir是目录下的全部文件
fopen = open('/media/lab/data/detection_data/1127/name_list.txt', 'w') # 替换为你的路径
